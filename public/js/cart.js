const productDetails = [
  ...
  function addItem(event) {
    let btnClicked = event.parentElement.parentElement.parentElement.parentElement.parentElement;
  ...
  <div class='card'>
    ...
    <div class='details'>
      ...
      <div class='purchase'>
        <p class='product-price'>VND ${price}</p>
  ...
  <div class='cart-item'>
    <div class='cart-img'>
      <img src='${imgSrc}' alt=''  style="width:4em; height:4em;" />
    </div>
    <strong class='name'>${name}</strong>
    <span class='qty-change'>${QtyBtn(qty)}</span>
    <p class='price'>VND ${price * qty}</p>
  ...
  <div class='side-nav'>
    ...
    <div class='final'>
      <strong>Total: VND <span class='total'>0</span>.00/-</strong>
      <div class='action'>
  ...
  function Purchase() {
    ...
    let itemPrices = cartDetails.map((item) => {
      return `<span>VND ${item.price * item.qty}</span>`;
    });
    return `
  <div class='invoice'>
  ...
  <hr>
    <div class='payment'>
      <em>payment</em>
      <div>
        <p>total amount to be paid:</p><span class='pay'>VND ${toPay}</span>
      </div>
    </div>
    <div class='order'>
  ...
  <div>
    <div class='order-details'>
      ...
      <p>you can pay <span>VND ${totalCost}</span> by card or any online transaction method after the products have been dilivered to you</p>
    </div>
